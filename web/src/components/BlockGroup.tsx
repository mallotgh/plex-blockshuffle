...
export default function BlockGroup({ block, onChange, selection, onTrackClick }: Props) {
  ...
  const sensors = useSensors(
    ...
    // Touch: kurze Haltezeit, damit Scrollen nicht als Ziehen interpretiert wird
...
function SortableTrack({
  ...
  return (
    ...
    >
      ...
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded bg-neutral-800 text-xs text-neutral-600">♪</div>
